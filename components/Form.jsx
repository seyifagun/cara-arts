...
const Form = ({ type, work, setWork, handleSubmit }) => {
  ...
  return (
    <div className="form">
      <h1>{type} Your Brand</h1>
      <form onSubmit={handleSubmit}>
        <h3>Which of these categories best describes your cloth?</h3>
        ...
        <h3>Add photos of cloth brands</h3>
        ...
        <h3>What makes your brand standout?</h3>
        ...
        <button className="submit_btn" type="submit">UPLOAD YOUR BRAND</button>
      </form>
    </div>
  );
};
